...
public class StreamGenerateAndFinalizeTest {
    ...
    public final void of_list_any_match() {
        ...
        assertEquals("Should be true if any match 2", true, numbers.anyMatch(x -> x.equals(2)));
    }
    ...
    public final void iterate_all_match() {
        ...
        assertEquals("Use all match to uneven", false, numbers.allMatch(x -> x == x+3));
    }
    ...
    public final void concat_min_max() {
        ...
        assertEquals("Should return the min", new Integer(31), numbers.min(Integer::compareTo)); // check Comparator#naturalOrder
        assertEquals("Should return the max", new Integer(34), numbers.max(Integer::compareTo)); // check Comparator#naturalOrder
    }
